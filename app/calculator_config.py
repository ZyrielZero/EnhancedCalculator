"""Configuration for the calculator, sourced from environment variables."""
...
# Pull values from a local .env file into the environment, if one exists.
load_dotenv()
...
class CalculatorConfig:
    """Holds every tunable setting the calculator needs.

    Each value comes from a constructor argument, an environment variable, or a
    built-in default, checked in that order.
    """
    ...
    def validate(self) -> None:
        """Reject any setting that doesn't make sense."""
